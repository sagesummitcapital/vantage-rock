...
If your close is running long and you want to know which of these applies to you, that is what the [Introduction Call](/#book) is for. Fifteen to thirty minutes, fit-check, no diagnosis on the call.
