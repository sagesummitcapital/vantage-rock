...
export const FAQS: { q: string; a: string }[] = [
  ...
  },
  {
    ...
    a: "No. Tax and audit stay with your CPA. Books stay with your bookkeeper. The work here is close, cash, forecast, and the pack.",
  },
  {
    q: "What size company do you work with?",
    a: "Founder-led and sponsor-backed companies from roughly $1M in revenue. Strongest in healthcare, retail, professional services, technology and SaaS, and multi-entity groups. If you don't have books yet, that's a bookkeeping engagement — we'll point you to someone who does it well.",
  },
  {
    q: "What does it cost?",
