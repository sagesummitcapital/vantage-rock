...
const DESCRIPTION =
  "AI-enabled finance is a finance function that can lead, not a dashboard with a prompt box. Fractional CFO. Introduction Call — fit-check. We don't diagnose on the call.";
        ...
        <article className="relative overflow-hidden border-b border-line">
          ...
          <div className="relative mx-auto max-w-[720px] px-6 py-16 md:px-10 md:py-24">
            ...
            <div className="mt-12 space-y-6 text-[17px] leading-[1.7] text-ink">
              ...
              <p>
                The Introduction Call is a fit-check. We
